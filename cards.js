...
(function(){
  ...
  SB.useCards = function(user, annoScolastico) {
    ...
    var [showMyCards, setShowMyCards] = useState(false);
    ...
    useEffect(function() {
      ...
      var u1 = fbListen(function(remote) {
        // ponytail: server_side_ordering; nextOrd.current non più affidabile per nuove card.
        // Usare SB.services.getNewCardOrder() per ordini atomici lato server.
