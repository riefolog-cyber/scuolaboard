...
function debugLog(...args) { if (SB_DEBUG_BOOT) console.log(...args); }
...
if(window._appRenderAttempts > 5) {
  ...
  // XSS-safe: costruisce i nodi con createElement + textContent, niente innerHTML.
...
if (diagnostics.length > 0) {
  ...
  _sbSetTextReport(document.getElementById("root"),
  ...
  try {
    ReactDOM.createRoot(document.getElementById("root")).render(
      hh(ErrorBoundary,null,hh(App,null))
    );
  } catch(e) {
    ...
    _sbSetTextReport(document.getElementById("root"),
      ["❌ Render Error: " + String(e.message || e)], "#f87171");
  }
}
