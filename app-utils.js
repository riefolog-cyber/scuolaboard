...
(function(){
  ...
  SB.LS={
    seen:{
      get:function(){
        try{
          var s=_safeGetItem(localStorage, "seen_cards");
      ...
      set:function(s){
        try{
          _safeSetItem(localStorage, "seen_cards", JSON.stringify([...s]));
        }catch(e){
    ...
    push:{
      get:function(){return _safeGetItem(localStorage, "push_enabled")==="true";},
      set:function(v){_safeSetItem(localStorage, "push_enabled", v?"true":"false");}
    },
    privacy:{
      get:function(uid){return _safeGetItem(localStorage, "privacy_accepted_"+uid);},
      set:function(uid){_safeSetItem(localStorage, "privacy_accepted_"+uid, "1");}
    },
    anno:{
      get:function(){
        try{
          return _safeGetItem(sessionStorage, "annoScolasticoAttivo")||"2025/2026";
        }catch(e){
      ...
      set:function(v){
        try{
          _safeSetItem(sessionStorage, "annoScolasticoAttivo", v);
        }catch(e){
