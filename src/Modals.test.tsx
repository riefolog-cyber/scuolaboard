...
describe("Modals", () => {
  function make$(): any {
    return {
      ...
      showClasseModal: false, setShowClasseModal: () => {}, classeInput: "", setClasseInput: () => {}, S: {}, CLASSI_LIST: [], CLASSI_DEFAULT: [], classeColor: () => "#fb923c", classiCustom: [], classeCorrente: null, saveClasse: () => {},
      showAiQuizGen: false, setShowAiQuizGen: () => {}, aqg: { testo: "", loading: false, err: "", numDom: 4, tipo: "multipla", anteprima: null, regenIdx: null }, setAqg: () => {}, aiGeneraQuiz: () => {}, aiRigenDomanda: () => {}, aiConfirmaQuiz: () => {},
      showAmm: null, setShowAmm: () => {}, cards: [], ammonisci: () => {},
      editAmm: null, setEditAmm: () => {}, modificaAmm: () => {},
      showProfilo: false, isProf: false, user: null, preferiti: [], setShowProfilo: () => {}, myName: () => "Test",
      showTimerModal: false, showCard: null, timerInput: "", setTimerInput: () => {}, setShowTimerModal: () => {}, setCardTimer: () => {},
      showModal: false, form: { tipo: "domanda", titolo: "", testo: "", opzioni: ["", ""], classi: [], links: [], immagini: [], allegati: [], quizDomande: [] }, setForm: () => {}, setShowModal: () => {}, editMode: null, setEditMode: () => {}, addCard: () => {}, handleImgUpload: () => {}, rimuoviImmagine: () => {}, setDidascalia: () => {}, imgUploading: false, handleAllegatiUpload: () => {}, handleRimuoviAllegato: () => {}, allegatiUploading: false, setAllegatiUploading: () => {}, showToast: () => {},
      showRifiutaModal: null, setShowRifiutaModal: () => {}, rifiutaInput: "", setRifiutaInput: () => {}, rifiutaProposta: () => {},
      confirmDel: null, setConfirmDel: () => {}, delCard: () => {},
    };
  }
