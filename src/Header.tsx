    ...
    >
      {
        <div style={{ display: 'flex', alignItems: 'center', gap: 0 }}>
          {
            <span style={{ fontWeight: 900, fontSize: 16, color: isLight ? '#0f172a' : '#fff', letterSpacing: 2 }}>
              SCUOLA
            </span>
          }
          {
      ...
      <div style={{ position: 'relative' }}>
        <button
          ...
          onClick={function (e: any) {
            e.stopPropagation();
            $.setShowNotifiche(function (v: any) {
              return !v;
            });
          }}
          style={{
            ...
            fontSize: 14,
            color:
              ($.nonLette || 0) > 0 ? (isLight ? '#4f46e5' : '#a5b4fc') : isLight ? '#334155' : 'rgba(255,255,255,.7)',
            position: 'relative',
          }}
        >
          🔔
        ...
        {$.showNotifiche && (
          <div
            ...
            style={{
              ...
              borderRadius: 14,
              boxShadow: isLight ? '0 12px 32px rgba(15,23,42,.12)' : '0 12px 40px rgba(0,0,0,.6)',
              zIndex: 400,
              padding: 8,
            }}
          >
            ...
            {(!$.notifiche || $.notifiche.length === 0) && (
              <div
                style={{
                  textAlign: 'center',
                  padding: 20,
                  color: isLight ? '#64748b' : 'rgba(255,255,255,.4)',
                  fontSize: 12,
                }}
              >
                Nessuna notifica
                ...
                return (
                  <div
                    ...
                    onClick={function () {
                      ...
                      var card = ($.cards || $.visibleSorted || []).find(function (c: any) {
                        return String(c.id) === String(n.cardId);
                      });
                    ...
                    style={{
                      ...
                      borderRadius: 8,
                      cursor: 'pointer',
                      background: n.letta ? 'transparent' : isLight ? 'rgba(79,70,229,.08)' : 'rgba(99,102,241,.10)',
                      border:
                        '1px solid ' +
                        (n.letta ? 'transparent' : isLight ? 'rgba(79,70,229,.14)' : 'rgba(99,102,241,.18)'),
                      marginBottom: 4,
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div
                        style={{ fontSize: 11, color: isLight ? '#475569' : 'rgba(255,255,255,.5)', lineHeight: 1.4 }}
                      >
                        {n.msg}
                      </div>
                      <div style={{ fontSize: 10, color: isLight ? '#64748b' : 'rgba(255,255,255,.35)', marginTop: 2 }}>
