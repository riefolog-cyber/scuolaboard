  ...
  beforeEach(() => {
    cards = [
      ...
      }, // Solo prof
      {
        ...
        testo: 'Domanda di approfondimento',
        classi: ['3AI'],
        commenti: [{ id: 'x', autore: 'Luca', testo: 'La lezione di fisica era interessante', data: '2026-01-01' }],
        ordine: 3,
        annoScolastico: '2026/2027',
      },
      {
        ...
        tipo: 'quiz',
        titolo: 'Quiz algebra',
        testo: 'Domande sulle equazioni',
        classi: ['TUTTE'],
        quizDomande: [{ testo: 'Risolvi x+2=5' }],
        ordine: 4,
        annoScolastico: '2026/2027',
      },
    ];
          ...
          forEach: (cb: any) => {
            cb({
              data: () => ({
                id: 'oldDb',
                tipo: 'nota',
                titolo: 'Equazioni anno precedente',
                testo: '',
                classi: ['3AO'],
                commenti: [],
                ordine: 50,
