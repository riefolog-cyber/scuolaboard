            ...
            <>
              ...
              {cRes.sintesi && (
                <div style={{ marginBottom: 8 }}>
                  <div style={{ fontSize: 11, fontWeight: 800, color: '#a5b4fc', letterSpacing: 1, marginBottom: 3 }}>
                    📋 SINTESI
                  </div>
              ...
              {cRes.dinamica && (
                <div style={{ marginBottom: 8 }}>
                  <div style={{ fontSize: 11, fontWeight: 800, color: '#93c5fd', letterSpacing: 1, marginBottom: 3 }}>
                    💬 DINAMICA
                  </div>
                  <div style={{ fontSize: 11, color: 'rgba(255,255,255,.75)', lineHeight: 1.6 }}>{cRes.dinamica}</div>
                </div>
              )}
              {cRes.spunto && (
                <div
                ...
                >
                  <div style={{ fontSize: 11, fontWeight: 800, color: '#4ade80', letterSpacing: 1, marginBottom: 3 }}>
                    💡 SPUNTO DIDATTICO
                  </div>
                  <div style={{ fontSize: 11, color: 'rgba(255,255,255,.8)', lineHeight: 1.6, fontStyle: 'italic' }}>
                    {cRes.spunto}
                  </div>
                </div>
              )}
